  ...
  return (
    <>
      <motion.div
        ...
        className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-white mb-[clamp(1rem,3vh,1.75rem)]"
      >
      ...
      >
        ...
        <br />
        <span className="text-[#93C5FD]">One conversation.</span>
      </motion.h1>
      ...
      >
        ...
        <a
          href="#demo"
          className="inline-flex items-center gap-2 border border-white/40 px-7 py-3.5 text-sm font-semibold text-white rounded-full hover:bg-white/10 transition-all active:scale-[0.98]"
        >
          <PlayCircle size={16} />
          See it in action
        </a>
      ...
      >
        <span className="inline-flex items-center gap-1.5"><ShieldCheck size={13} className="text-[#93C5FD]" /> No spreadsheets</span>
        <span className="w-1 h-1 rounded-full bg-white/30" />
        <span className="inline-flex items-center gap-1.5"><ShieldCheck size={13} className="text-[#93C5FD]" /> No setup fees</span>
        <span className="w-1 h-1 rounded-full bg-white/30" />
        <span className="inline-flex items-center gap-1.5"><ShieldCheck size={13} className="text-[#93C5FD]" /> Built for South Africa</span>
      </motion.div>
    </>
  );
}
...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-white text-vanta-black font-sans antialiased selection:bg-vanta-navy selection:text-white">
      ...
      {/* Hero Section — the brand's own gradient render, copy set into its open space */}
